...
import { addOutline, enterOutline, document, globe, downloadOutline } from 'ionicons/icons';

import { ref } from 'vue';
import CreateBrew from '../components/CreateBrew.vue';
import BrewView from '../components/BrewView.vue';

const isOpen = ref(false);
const currentbrew = ref();
